...
namespace LnkSerialization.UnitTests
{
  public class UnitTest
  {
    ...
    {
      var adminModel = new LinkModel("Resources/ie-admin.lnk");
      Assert.True(adminModel.RunAsAdmin);
      var noAdminModel = new LinkModel("Resources/ie.lnk");
    ...
    {
      var argsModel = new LinkModel("Resources/ie-argument.lnk");
      Assert.True(argsModel.Args.Length > 0);
      var noArgsModel = new LinkModel("Resources/ie.lnk");
    ...
    {
      Core.LnkSerialization.SerializeAsShortcutJson("Resources/dir-non-working.lnk");
      var lnkModel = new LinkModel("Resources/dir-non-working.lnk");
      lnkModel.SerializeJson("dir-non-working-AsLnkModel.json");
